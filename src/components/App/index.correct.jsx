...
import { deleteNotes, getNotes, putNote, saveNotesToLocalStorage } from "../../utils/storage";
...
function App({ mobxStore }) {
  ...
  return (
    // Moved DarkModeProvider to src/index.jsx
    <div className="notes">
      <div className="notes__columns">
        ...
        <div className="notes__column notes__column_primary">
          <div className="notes__column-content">
            <PrimaryPane activeNoteId={activeNoteId} notes={notes} saveNote={saveNote} />
          </div>
        </div>
      </div>
